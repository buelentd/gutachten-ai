...
const features = [
  {
    ...
    imgSrc: "https://lh3.googleusercontent.com/aida-public/AB6AXuDjjyoM2_SSHUdkRUAfj6ZAZXNTAXKUzpJhh4pYVAWH5AkMBgLM0cpR_BUFmOAoE6HeqWbK-LFoygaoZkHyH2FYkXe-dLli8I6Xo2jrbpgJAdR7iSK2T9aaA4nGDaIX6IEsU4XC53Hg56mbIDrFlexE9Bq3cIpR-lxJOaLjoL63v_d8UazhwplWk_rXzazYGExKgu4vBfCuhw7WxISS95Hm-lx-8JEYARSKJ_Rgif4yxPl6KDWDyMCo9SjnUrVtGweQ3P9wc_rKeSvh",
    imgAlt: "Dark UI interface showing an AI chat interaction",
    reverse: false,
  },
  {
    icon: "photo_camera",
    ...
    imgSrc: "https://lh3.googleusercontent.com/aida-public/AB6AXuC_zw392Y_3qVSoMPUtUzvSKlF-jFJJxFKW2VBydoX6r_HqCXDpi6ag-fNoH7-s_ysH2vl8VidOy7IHY1u0_G66iB5-kT1QPnyngYtQANBAtWfWY5PvElfBb84yLE8BNaTf-oXtPGpYPzZXwaGkbiVQHJ1qY6nXFp4ZMuKZ-Bi75at-v0S0HYlZGN9FnM1KfSKO2DmdeupKMUtkULrOGuYDTOsUB8aw7nLPia9GQRMQt0XYHHLV3aGQsz3QWolGEtzUI1pC-09MpXBN",
    imgAlt: "Technical photo of a wall crack with AI overlay",
    reverse: true,
  },
  {
    icon: "gavel",
    ...
    imgSrc: "https://lh3.googleusercontent.com/aida-public/AB6AXuA9Lh0_MMs4RqF8LUzEv_vYg3siiz7qJMu2Y6wcAQmPurEZLeAdDqyvHgYSL7QwgN3OWHm8G-McrtdLhn8sP951uMFYyZykKXCTg39Zh8IglrZAOLSNeI0s_RprW6iAqChufGm0pw5KmYoXTOLGej4nG4mt4dRLaJCLT3LnyhGic0pUeJVck97yhIy2S8SRsyz-Qntsz6fSYfWNmzgiSrMPYZY39fQXmWZoGnEn6DUesbAsoRV43EGQLKIHiHJ9DFuSDdHZpfc2Rsjl",
    imgAlt: "Document viewer displaying DIN norm text",
    reverse: false,
  },
  {
    icon: "mic",
    ...
    imgSrc: "https://lh3.googleusercontent.com/aida-public/AB6AXuBtGotFfPDt8OlbXBw_PIqNbYHaNhZ4u88Kfz2LjyyxS0EDcrw9zV8ULx2G1qxdeQLvt3DN23YzMvDOxiSKmDvXdrgvM2O-rPy-FAXWQecV6wuJm2TVKAlhI91Fos7krJ9JBPqXkCfY7dU-OmPciSZsbE0aIKkVnyWecDgBkb5nDsIkbFoFHf7obTqK32AcBxSjMys-A0rySe5jBscJQCG8jkVozkqHGb-ImqUR8ximQwJUzjPnyCeXVfmCJuhBXWr3vx1Ol-CMv_km",
    imgAlt: "Audio waveform visualization with text transcription",
    reverse: true,
  },
  {
    icon: "description",
    ...
    imgSrc: "https://lh3.googleusercontent.com/aida-public/AB6AXuA6TJXj120jN3BT7HKbKPapa1CB-tL9_ga9uDk-J9bEYiHTIhFKLRGHOov1SK8VRr33IHGgLmBVVyXX3whkMtiuowcSzsyAqahHk0WRihQPgTE9ea0k4sif6r6tpMN2f6t1TwBo9lGvPoYdN4szbg4ZqzhiFH4ubB6IYt3BbygaitwY8bGGF_KcPaowxC9DUg8qZgyrPeYxDBUBp_X1dKvPkxKII2YFS_fpGojYFxQ09QlLjl3DWEEDDPAwvRHbP-FlSvT0rk9QKYR_",
    imgAlt: "Modern text editor showing professional document structure",
    reverse: false,
  },
  {
    icon: "receipt_long",
    title: "Rechnungen",
    desc: "Automatisierte Erstellung von JVEG-konformen Rechnungen oder Honorarberechnungen nach Zeitaufwand. Integrieren Sie Ihre Stundensätze nahtlos.",
    example: "Ein-Klick-Erstellung der Gesamtabrechnung nach Abschluss des Gutachtens inkl. aller Nebenkosten.",
    imgSrc: "https://lh3.googleusercontent.com/aida-public/AB6AXuBZYWBqa-Z36nramZlsZQt-pu-KEEeFGJ-QOfUkoydtxtbC5DG91E_eaQOCjblLkg7VTf9aJh7CNZrDcaXXxgsbucjOMRjieFddIZD942eIkBYIN1HTDxBG9R2si6gHsCwk2yDfsCtJkW4A-GZtbkIFLoFeSinDC1wqGvpF1JPllQU0yP_YzZbLW8IE_3JxtFsSEnHrjErxnYvzgiuPYfGLxd2p0Vb97cZTq4Smbb8oVDWexR6fFGuaLP2KnSyoMQ0aIkdzVJfspxBk",
    imgAlt: "Clean dashboard showing financial summary",
    reverse: true,
  },
];
  ...
  return (
    <main className="pt-32 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-6 space-y-32">
        {features.map((f, i) => (
          <div key={i} className="grid grid-cols-12 gap-8 items-start">
            ...
            <div className={`col-span-12 md:col-span-7 bg-[#272A31] aspect-video rounded-xl overflow-hidden border-[0.5px] border-[#594238] flex items-center justify-center ${f.reverse ? "order-2 md:order-1" : ""}`}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img className="object-cover w-full h-full opacity-60" alt={f.imgAlt} src={f.imgSrc}/>
            </div>
          </div>
        ))}
      </section>
      ...
      <section className="mt-48 max-w-4xl mx-auto px-6">
        <h2 className="text-4xl font-normal tracking-tight text-center mb-16 text-[#F0EDE6]">Häufig gestellte Fragen</h2>
        <div className="space-y-4">
          {[
            ...
            <div key={i} className="bg-[#191C22] rounded-xl p-6 border-[0.5px] border-[#594238]">
              <h3 className="text-lg font-medium mb-2 text-[#F0EDE6]">{item.q}</h3>
              <p className="text-[#E0C0B3] leading-relaxed">{item.a}</p>
            </div>
          ))}
        </div>
      </section>
