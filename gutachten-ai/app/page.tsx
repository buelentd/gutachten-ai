      ...
      <section className="relative min-h-[819px] flex items-center bg-[#0F1218] overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative hidden md:block">
            ...
            <img
              alt="Modern architecture drawing"
              className="relative rounded-2xl border-[0.5px] border-[#2A3344] shadow-2xl grayscale hover:grayscale-0 transition-all duration-700 object-cover aspect-[4/5] w-full"
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center md:text-left">
              ...
              <div className="text-xs text-[#E0C0B3] font-medium tracking-wider uppercase">Zeitersparnis</div>
            </div>
            <div className="text-center md:text-left">
              <div className="text-3xl font-medium text-[#F0EDE6] mb-1">2.4k+</div>
              <div className="text-xs text-[#E0C0B3] font-medium tracking-wider uppercase">Gutachten erstellt</div>
            </div>
            <div className="text-center md:text-left">
              <div className="text-3xl font-medium text-[#F0EDE6] mb-1">100%</div>
              <div className="text-xs text-[#E0C0B3] font-medium tracking-wider uppercase">Rechtssicher (DSGVO)</div>
            </div>
            <div className="text-center md:text-left">
              <div className="text-3xl font-medium text-[#F0EDE6] mb-1">&lt; 5min</div>
              <div className="text-xs text-[#E0C0B3] font-medium tracking-wider uppercase">Erstellungsdauer</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#2A3344]">
            {[
              ...
              <div key={i} className="p-10 bg-[#101319] hover:bg-[#1D2026] transition-colors group">
          ...
          <div className="flex items-center gap-6">
            <div className="flex -space-x-3">
              {[
                ...
                <div key={i} className="w-10 h-10 rounded-full border-2 border-[#272A31] bg-[#1D2026] overflow-hidden">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
