  ...
  return (
    <main>
      ...
      <section className="py-24 bg-[#151B27]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16 text-center">
            <h2 className="text-4xl font-medium text-[#F0EDE6] mb-4">{d?.featuresTitle}</h2>
            <p className="text-[#8A9BB0] max-w-xl mx-auto">{d?.featuresSubtext}</p>
          </div>
      ...
      <section className="py-24 bg-[#0F1218]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16 text-center">
            <h2 className="text-4xl font-medium text-[#F0EDE6] mb-4">{d?.ablaufTitle}</h2>
            <p className="text-[#8A9BB0] max-w-2xl mx-auto">{d?.ablaufSubtext}</p>
          </div>
      ...
      <section className="py-24 bg-[#151B27]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16 max-w-2xl">
            <h2 className="text-4xl font-medium text-[#F0EDE6] mb-4">{d?.fuerWenTitle}</h2>
            <p className="text-[#8A9BB0]">{d?.fuerWenSubtext}</p>
          </div>
