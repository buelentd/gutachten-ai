  ...
  try {
    ...
    await client.createOrReplace({
      ...
      sections: [
        ...
        { _key: "ds5", title: "5. Cookies und Analyse-Tools", content: "Diese Website setzt keine eigenen Cookies.\n\nZur Messung und Analyse der Nutzung binden wir Google Analytics 4 ein. Anbieter ist Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland. Google Analytics 4 setzt im Browser folgende Cookies:\n\n— _ga: dient zur Unterscheidung einzelner Besucher. Speicherdauer: 24 Monate.\n— _ga_MZNP1LYCPH: speichert Session-Informationen zur aktuellen Property. Speicherdauer: 24 Monate.\n\nZweck: statistische Auswertung der Website-Nutzung zur Verbesserung des Angebots. Rechtsgrundlage ist Ihre Einwilligung gemäß Art. 6 Abs. 1 lit. a DSGVO in Verbindung mit § 25 Abs. 1 TTDSG. Die Einwilligung können Sie jederzeit mit Wirkung für die Zukunft widerrufen, indem Sie die Cookies in Ihrem Browser löschen oder den Zugriff durch Google Analytics in den Browser-Einstellungen unterbinden.\n\nIm Rahmen der Verarbeitung können Daten an Google LLC in den USA übermittelt werden. Google LLC ist zertifiziert nach dem EU-US Data Privacy Framework." },
