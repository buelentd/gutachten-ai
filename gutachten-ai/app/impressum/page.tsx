        ...
        <div className="space-y-10 text-on-surface">
          <section>
            ...
            <p className="text-on-surface leading-relaxed">
              {d?.firmenname}<br />{d?.strasse}<br />{d?.plz} {d?.ort}<br />{d?.land}
            </p>
          </section>
          <section>
            <h2 className="text-sm font-medium text-on-surface-variant uppercase tracking-widest mb-4">Handelsregister</h2>
            <p className="text-on-surface leading-relaxed">
              Registergericht: {d?.registergericht}<br />Registernummer: {d?.registernummer}
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="text-on-surface leading-relaxed">Telefon: {d?.telefon}<br />E-Mail: {d?.email}</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="text-on-surface-variant leading-relaxed text-sm">
              ...
              <a href="https://ec.europa.eu/consumers/odr" className="text-[#E8631A] hover:underline" target="_blank" rel="noopener noreferrer">https://ec.europa.eu/consumers/odr</a>
            </p>
          </section>
          <section>
            <h2 className="text-sm font-medium text-on-surface-variant uppercase tracking-widest mb-4">Verbraucherstreitbeilegung</h2>
            <p className="text-on-surface-variant leading-relaxed text-sm">Wir sind nicht bereit oder verpflichtet, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.</p>
          </section>
        </div>
      </div>
    </main>
