        ...
        <div className="space-y-10 text-on-surface">
          ...
          <section>
            ...
            <p className="text-on-surface-variant leading-relaxed text-sm">
              ...
              <a href="https://ec.europa.eu/consumers/odr" className="text-[#C54F0E] hover:underline" target="_blank" rel="noopener noreferrer">https://ec.europa.eu/consumers/odr</a>
            </p>
          </section>
          <section>
