...
export function Footer() {
  ...
  return (
    <footer className="bg-bg border-t-[0.5px] border-outline">
      <div className="flex flex-col md:flex-row justify-between items-center gap-8 py-12 px-8 max-w-7xl mx-auto">
        <div className="flex flex-col items-center md:items-start gap-4">
          <div className="flex items-center gap-2">
            <ArchitectureIcon />
            <span className="text-lg font-medium text-on-surface">gutachten-ai.de</span>
          </div>
          <p className="font-normal text-xs leading-relaxed text-on-surface-variant max-w-xs text-center md:text-left">
        ...
        <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
          {links.map((link) => (
            <Link key={link.href} href={link.href}
              className={`font-normal text-xs hover:text-primary transition-colors ${pathname === link.href ? "text-on-surface" : "text-on-surface-variant"}`}>
              {link.label}
            </Link>
          ))}
          <button
            ...
            className="font-normal text-xs text-on-surface-variant hover:text-primary transition-colors"
          >
      ...
      <div className="max-w-7xl mx-auto px-8 pb-8 text-center">
        <span className="font-normal text-xs text-on-surface-variant">
